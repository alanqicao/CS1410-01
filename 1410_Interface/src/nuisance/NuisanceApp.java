...
public class NuisanceApp {
	...
	public static void main(String[] args) {
		...
		//Test interface Nuisance
			Nuisance[] nuisanceArray = {telMarketer1,mosq1,pMosq1};
			System.out.println("3 Nuisances: ");
			
			for(Nuisance e: nuisanceArray) {
				if(e instanceof Mosquito) {
					System.out.println(((Mosquito)e).buzz());
				
				}
				if(e instanceof PeskyMosquito) {
					System.out.println(((PeskyMosquito)e).bite());
					
				}
				if(e instanceof Nuisance){
					System.out.println(e.annoy());
